...
class MyCarSystem {
	...
	public void start() {
        ...
        Car car1 = new Car("Lamborghini", "Aventador S", 2021, 421000.0d, owner1);
        Car car2 = new Car("Ford", "F-150 Rapto", 2024, 65000.99d, owner2);
        Car car3 = new Car("Aston Martin", "DB11", 2025, 205600.78d, owner3);
	...
	public Car createCar(CarOwner owner) {
        ...
        Car car = new Car(make, model, year, price, owner);
        return car;
    }
